...
guard :concat, type: "js", files: %w(plugins/console plugins/flexslider plugins/transit plugins/enquire plugins/equalsize plugins/typography app), input_dir: "_includes/js", output: "assets/js/app"
